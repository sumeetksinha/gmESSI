...
ElementList = GmshConverter.getSphereSelectionData("Physical_Group#11",0.5,1.5,0.5,0.5).ElementList
...
GmshConverter.Convert("[Add_Self_Weight{Physical_Group#1,1}]")
